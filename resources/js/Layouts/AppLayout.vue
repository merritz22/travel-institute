            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('programs')" :active="route().current('programs')">
                                    Programmes
                                </NavLink>
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        ...
                                        <span v-else class="inline-flex rounded-md">
                                            <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                                                {{  $page.props.auth.user != null ? $page.props.auth.user.name : "" }}
                                    ...
                                    <template #content>
                                        ...
                                        <!-- Authentication -->
                                        <form v-if="$page.props.auth.user != null" @submit.prevent="logout">
                                            <DropdownLink as="button">
                                                Déconnexion
                                            </DropdownLink>
                                        </form>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('programs')" :active="route().current('programs')">
                            Programmes
                        </ResponsiveNavLink>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        <div v-if="$page.props.auth.user != null" class="flex items-center px-4">
